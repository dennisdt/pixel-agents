...
function App() {
  ...
  const { agents, selectedAgent, agentTools, agentStatuses, subagentTools, subagentCharacters, layoutReady, loadedAssets, workspaceFolders, directoryExp, agentCwds } = useExtensionMessages(getOfficeState, editor.setLastSavedLayout, isEditDirty)
  ...
  const handleSelectAgent = useCallback((id: number) => {
    getBackend().postMessage({ type: 'focusAgent', id })
  }, [])
